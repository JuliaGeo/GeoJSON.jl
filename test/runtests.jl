...
facts("A: CRS link") do
    ...
    @fact typeof(feature) --> GeoInterface.Feature
...
facts("B: Multipoint") do
    ...
    @fact GeoInterface.coordinates(GeoInterface.geometry(feature)) --> [[-155.52,19.61],[-156.22,20.74],[-157.97,21.46]]
    @fact GeoInterface.properties(feature) --> feature.properties
    @fact typeof(feature.properties) --> Dict{String,Any}
    @fact length(feature.properties) --> 2
...
facts("D: MultiLineString") do
    ...
    @fact feature.geometry.coordinates --> [[[3.75,9.25],[-130.95,1.52]],[[23.15,-34.25],[-1.35,-4.65],[3.45,77.95]]]
    @fact GeoInterface.properties(feature) --> feature.properties
    @fact typeof(feature.properties) --> Dict{String,Any}
    @fact length(feature.properties) --> 3
...
facts("Realmultipolygon") do
    ...
    @fact feature.geometry.coordinates --> [[[[102.0,2.0],[103.0,2.0],[103.0,3.0],[102.0,3.0],[102.0,2.0]]],[[[100.0,0.0],[101.0,0.0],[101.0,1.0],[100.0,1.0],[100.0,0.0]],[[100.2,0.2],[100.8,0.2],[100.8,0.8],[100.2,0.8],[100.2,0.2]]]]
...
facts("Polyline") do
    ...
    @fact feature.geometry.coordinates --> [[-89.0,43.0],[-88.0,44.0],[-88.0,45.0]]
    dict = geo2dict(testobj)
    @fact dict["type"] --> "FeatureCollection"
...
facts("Poly") do
    ...
    dict = geo2dict(testobj)
    @fact dict["type"] --> "FeatureCollection"
    @fact dict["features"][1] --> geo2dict(feature)
    dict = geo2dict(feature)
...
facts("OSM buildings") do
    ...
    @fact map(typeof,buildings.features) --> fill(GeoInterface.Feature,4)
...
facts("Tech Square: parsefile") do
