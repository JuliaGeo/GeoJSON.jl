...
@fact GeoInterface.bbox(feature) => roughly([-180.0, -90.0, 180.0, 90.0])
...
feature = features[1]
@fact GeoInterface.bbox(feature) => feature.properties["bbox"]
@fact GeoInterface.bbox(feature) => roughly([100.0, 0.0, 105.0, 1.0])
...
@fact length(features) => 1
feature = features[1]
@fact typeof(GeoInterface.geometry(feature)) => MultiPolygon
@fact GeoInterface.geometry(feature) => feature.geometry
